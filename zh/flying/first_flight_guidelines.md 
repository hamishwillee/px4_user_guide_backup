...
> **Note** It can be useful to [set a kill switch on your transmitter](../config/flight_mode_configuration.md#kill-switch). This allows you to immediately crash your drone if necessary.
